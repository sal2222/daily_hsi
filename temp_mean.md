...
## observations: 139875 
## range: 1.467917 to 101.0642 
## lag period: 0 5 
## total df:  20 
## 
## BASIS FOR VAR:
## fun: ns 
## knots: 66.93875 75.995 80.53667 84.02625 
## intercept: FALSE 
## Boundary.knots: 1.467917 101.0642 
## 
## BASIS FOR LAG:
## fun: ns 
...
```
##       75       80       85       90 
## 3.006538 4.105027 6.644215 9.457347
```
...
|:---|--------:|--------:|---------:|
|75  | 3.006538| 2.725859|  3.316119|
|80  | 4.105027| 3.707078|  4.545695|
|85  | 6.644215| 5.964180|  7.401787|
|90  | 9.457347| 8.369460| 10.686640|
...
![](temp_mean_files/figure-html/unnamed-chunk-4-2.png)<!-- -->
...
![](temp_mean_files/figure-html/unnamed-chunk-4-3.png)<!-- -->
...
gg_3d <-
  df_3d %>% 
  filter(`Mean Temperature` >= 60) %>% 
  ggplot() +
    geom_raster(aes(x = `Mean Temperature`, y = `Lag`, fill = `OR`)) +
    scale_fill_viridis()
...
![](temp_mean_files/figure-html/unnamed-chunk-5-1.png)<!-- -->
...
![](temp_mean_files/figure-html/unnamed-chunk-6-1.png)<!-- -->
...
![](temp_mean_files/figure-html/unnamed-chunk-7-1.png)<!-- -->
...
![](temp_mean_files/figure-html/unnamed-chunk-8-1.png)<!-- -->
